 ...
 * To keep the full app (todos + chat) exercisable locally, the server and client
 * fall back to this stable mock user when no real Identity user is present AND we
